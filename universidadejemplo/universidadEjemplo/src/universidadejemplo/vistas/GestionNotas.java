...
public class GestionNotas extends javax.swing.JInternalFrame {
    ...
    private void cargarMateriasInscriptas() {
        Alumno selectedAlumno = (Alumno) jcbListaAlumnos.getSelectedItem();
    List<Inscripcion> inscripciones = inscripcionData.obtenerMateriasCursadas(selectedAlumno.getIdAlumno());
    for (Inscripcion inscripcion : inscripciones) {
        ...
        modelo.addRow(new Object[]{inscripcion.getIdInscripcion(), materia.getNombre(), nota});
    }
    }
